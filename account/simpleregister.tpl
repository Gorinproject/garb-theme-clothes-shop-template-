                    ...
                    <?php foreach ($customer_fields as $field) { ?>
                        ...
                        <?php if ($j == 0 && $simple_registration_view_customer_type) { ?>
                            <tr>
                                ...
                                <td class="simplecheckout-customer-centre">
...
<?php if ($field['id'] == 'main_email') { ?><td rowspan="4"> </td>
<td rowspan="4" class="simplecheckout-customer-right"><p>После быстрой регистрации Вам необходимо в личном кабинете в разделе "Адреса" корректно заполнить поля: ФИО, Город, Адрес.
</br></br>Указывайте мобильный телефон, который находится всегда при вас.</p></td>
<?}?>
                            </tr>
                        <?php } ?>
...
<td>3После быстрой регистрации Вам необходимо в личном кабинете в разделе "Адреса" корректно заполнить поля: ФИО, Город, Адрес.
</br>Указывайте мобильный телефон, который находится всегда при вас.</td>
                    ...
                    <?php if ($simple_registration_captcha) { ?>
                        ...
                        <tr>
                          ...
                          <td class="simplecheckout-customer-centre"><img src="index.php?<?php echo $simple->tpl_joomla_route() ?>route=product/product/captcha" alt="" id="captcha" /></td>
                        </tr>
                    <?php } ?>
                </table>        
                <?php foreach ($customer_fields as $field) { ?>
